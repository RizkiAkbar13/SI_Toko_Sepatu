                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('pengguna') }}">Data Barang</a></li>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('barang.store') }}" method="post"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="email-id-vertical" class="form-control"
                                                        placeholder="Masukkan Nama" name="NAMA_BARANG" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="email-id-vertical" class="form-control"
                                                        placeholder="Masukkan Harga" name="HARGA" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">

                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical"
                                    action="{{ route('pembeli.update', $pembeli->ID_PEMBELI) }}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="email-id-vertical" class="form-control"
                                                        placeholder="Masukkan Nama" name="NAMA_PEMBELI"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="JK" id="JK" required>
                                                        ...
                                                        <option value="laki-laki"
                                                            {{ $pembeli->JK == 'laki-laki' ? 'selected' : '' }}>Laki-Laki
                                                        </option>
                                                        <option value="perempuan"
                                                            {{ $pembeli->JK == 'perempuan' ? 'selected' : '' }}>Perempuan
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="email-id-vertical" class="form-control"
                                                        placeholder="Masukkan Nomor Telepon" name="NO_TLP"
                                                        value="{{ $pembeli->NO_TLP }}" required>
                                                </div>
                                            </div>

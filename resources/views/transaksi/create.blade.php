                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('transaksi.store') }}" method="post"
                                                    ...
                                                    <select class="form-control" name="ID_BARANG" id="ID_BARANG">
                                                        ...
                                                        @foreach ($barang as $k)
                                                            <option value="{{ $k->ID_BARANG }}">
                                                                {{ $k->NAMA_BARANG }} x1 - Rp{{ number_format($k->HARGA, 0, ',', '.') }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="email-id-vertical" class="form-control"
                                                        placeholder="Masukkan Keterangan (beri tanda `-` jika tidak ada)" name="KETERANGAN" required>
                                                </div>
                                            </div>
